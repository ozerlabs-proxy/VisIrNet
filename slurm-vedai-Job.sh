...
#SBATCH --job-name=vedai_l2_homography_loss
...
srun nvidia-smi && python Train.py --config-file vedai_default_config.json --r_loss_function l2_homography_loss --b_loss_function ssim_pixel --train_second_stage True 
srun nvidia-smi && python Train.py --config-file vedai_default_config.json --r_loss_function l2_homography_loss --b_loss_function mse_pixel  --train_second_stage True
srun nvidia-smi && python Train.py --config-file vedai_default_config.json --r_loss_function l2_homography_loss --b_loss_function mae_pixel  --train_second_stage True
srun nvidia-smi && python Train.py --config-file vedai_default_config.json --r_loss_function l2_homography_loss --b_loss_function sse_pixel  --train_second_stage True
